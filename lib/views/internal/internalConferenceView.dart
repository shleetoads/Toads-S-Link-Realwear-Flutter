...
class InternalConferenceView extends ConsumerStatefulWidget {
  const InternalConferenceView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _InternalConferenceViewState();
}

class _InternalConferenceViewState
    extends ConsumerState<InternalConferenceView> {
  int perPage = 6;
  int nowPage = 0;
